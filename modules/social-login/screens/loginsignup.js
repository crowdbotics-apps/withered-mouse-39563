...
const SocialButtonsView = props => <View>
    ...
    <GoogleSigninButton onPress={props.onGoogleConnect} size={GoogleSigninButton.Size.Wide} color={GoogleSigninButton.Color.Dark} disabled={props.loading} style={_styles.qbldpmnV} />
    {(Platform.OS === "ios" || appleAuthAndroid.isSupported) && <AppleButton onPress={props.onAppleConnect} buttonStyle={AppleButton.Style.WHITE_OUTLINE} buttonType={AppleButton.Type.SIGN_IN} style={_styles.JQudUKPc} />}
  </View>;
